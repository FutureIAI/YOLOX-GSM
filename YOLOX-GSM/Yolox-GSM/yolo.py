...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : r'D:\Pycharm\project-tiny\yolox-addhead\yolox-pytorch-main\logs\loss_2024_03_22_10_33_35\best_epoch_weights.pth',
        "classes_path"      : 'model_data/fpc_classes_11.txt',
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [640, 640],
